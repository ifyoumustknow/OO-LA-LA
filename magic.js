window.onload = function () {
    ...
    $(document).on('click', '#submit', function () {
        ...
        $(document).on('click', '#button1', function () {
            ...
            $("#body2").append(`<p>I knew a ${gender2} who like scary stories, too. These were 3 of ${gender3} favorites:<p>`);
