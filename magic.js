window.onload = function () {
    ...
    $(document).on('click', '#submit', function () {
        ...
        $(document).on('click', '#story2', function () {
            ...
            Choose:
            <span><h5 id="getout">1.) Pull yourself together.</h5><h5 id="stay">2.) I'm fine, nothing to worry about</h5></span>`)
